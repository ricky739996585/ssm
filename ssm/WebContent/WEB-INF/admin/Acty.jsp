				...
				<div class="table-responsive" id="table">
					<div class="col-md-8 column">
						<form class="form-horizontal" role="form" method="post"
							action="updateActy.action" enctype="multipart/form-data">
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">活动海报</label>
								<div class="col-sm-10">
									<img src="${requestScope.actyImg }" width="200px"
										height="200px"><br />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="actyBean.acty_id"
										placeholder="请不要修改"
										value="<s:property value="mapActy['acty_id']"/>"
										readonly="readonly" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control"
										name="actyBean.acty_title" placeholder="请输入标题"
										value="<s:property value="mapActy['acty_title']"/>" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="#"
										placeholder="请输入发起用户"
										value="<s:property value="mapActy['user_name']"/>"
										readonly="readonly" />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control"
										name="actyBean.acty_people" placeholder="请输入参与人数"
										value='<s:property value="mapActy['acty_people']"/>' />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="#"
										placeholder="请输入发起时间"
										value='<s:property value="mapActy['acty_time']"/>'
										readonly="readonly" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea rows="12" cols="18" class="form-control"
										name="actyBean.acty_content" placeholder="此处为内容" wrap="hard"><s:property
											value="mapActy['acty_content']" /></textarea>
								</div>
							</div>
