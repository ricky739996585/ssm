					...
					<table class="table">
						...
						<s:if test="arrayListUser!=null">
							...
							<tbody>
								...
								<s:iterator value="arrayListUser" status="users">
									<tr class="success">
										<td><s:property value="user_id" /></td>
										<td><s:property value="user_name" /></td>
										<td><s:property value="user_psw" /></td>
										<td><s:property value="user_sex" /></td>
										<td><s:property value="user_nick" /></td>
										<td><s:property value="user_time" /></td>
										<td><s:property value="user_status" /></td>
										<td><a
											href="getUser.action?userBean.user_id=<s:property value="user_id"/>">编辑信息</a>
											<a
											href="deleteUser.action?userBean.user_id=<s:property value="user_id"/>">删除</a>
										</td>
									</tr>
								</s:iterator>
						</s:if>
						<s:else>
							<s:if test="userBean!=null">
								...
								<tbody>
									<tr class="success">
										<td><s:property value="userBean.user_id" /></td>
										<td><s:property value="userBean.user_name" /></td>
										<td><s:property value="userBean.user_psw" /></td>
										<td><s:property value="userBean.user_sex" /></td>
										<td><s:property value="userBean.user_nick" /></td>
										<td><s:property value="userBean.user_time" /></td>
										<td><s:property value="userBean.user_status" /></td>
										<td><a
											href="getUser.action?userBean.user_id=<s:property value="userBean.user_id"/>">编辑信息</a>
											<a
											href="deleteUser.action?userBean.user_id=<s:property value="userBean.user_id"/>">删除</a>
										</td>
									</tr>
							</s:if>
							</tbody>
