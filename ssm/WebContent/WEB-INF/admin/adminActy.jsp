					...
					<table class="table">
						...
						<s:if test="arrayListActy!=null">
							...
							<tbody>
								...
								<s:iterator value="arrayListActy" status="acty">
									<tr class="success">
										<td><s:property value="acty_id" /></td>
										<td><s:property value="acty_title" /></td>
										<td><s:property value="user_id" /></td>
										<td><s:property value="acty_time" /></td>
										<td><s:property value="acty_people" /></td>
										<td><s:property value="acty_status" /></td>
										<td><a
											href="getActy.action?actyBean.acty_id=<s:property value="acty_id"/>">编辑信息</a>
											<a
											href="deleteActy.action?actyBean.acty_id=<s:property value="acty_id"/>">删除</a>
										</td>
									</tr>
								</s:iterator>
						</s:if>
						<s:else>
							<s:if test="actyBean!=null">
								<thead>
									<tr>
										<th>序号</th>
										<th>活动标题</th>
								...
								<tbody>
									<tr class="success">
										<td><s:property value="actyBean.acty_id" /></td>
										<td><s:property value="actyBean.acty_title" /></td>
										<td><s:property value="actyBean.user_id" /></td>
										<td><s:property value="actyBean.acty_time" /></td>
										<td><s:property value="actyBean.acty_people" /></td>
										<td><s:property value="actyBean.acty_status" /></td>
										<td><a
											href="getActy.action?actyBean.acty_id=<s:property value="actyBean.acty_id"/>">编辑信息</a>
											<a
											href="deleteActy.action?actyBean.acty_id=<s:property value="actyBean.acty_id"/>">删除</a>
										</td>
									</tr>
							</s:if>
							</tbody>
