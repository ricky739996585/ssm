							...
							<tbody>
								...
								<s:iterator value="arrayListBook" status="book">
									<tr class="success">
										...
										<td><s:property value="book_time" /></td>
										<td><s:property value="book_author" /></td>
										<td><s:property value="book_publish" /></td>
										<td><s:property value="book_type" /></td>
										<td><a
											href="getBook.action?bookBean.book_id=<s:property value="book_id"/>">编辑信息</a>
											<a
											href="deleteBook.action?bookBean.book_id=<s:property value="book_id"/>">删除</a>
										</td>
									</tr>
								</s:iterator>
						</s:if>
						<s:else>
							<s:if test="bookBean!=null">
								<thead>
									<tr>
										<th>序号</th>
										<th>图书名</th>
								...
								<tbody>
									<tr class="success">
										<td><s:property value="bookBean.book_id" /></td>
										<td><s:property value="bookBean.book_name" /></td>
										<td><s:property value="bookBean.book_time" /></td>
										<td><s:property value="bookBean.book_author" /></td>
										<td><s:property value="bookBean.book_publish" /></td>
										<td><s:property value="bookBean.book_type" /></td>
										<td><a
											href="getBook.action?bookBean.book_id=<s:property value="bookBean.book_id"/>">编辑信息</a>
											<a
											href="deleteBook.action?bookBean.book_id=<s:property value="bookBean.book_id"/>">删除</a>
										</td>
									</tr>
							</s:if>
							</tbody>
