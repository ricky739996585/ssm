						...
						<s:if test="arrayListFilm!=null">
							...
							<tbody>
								...
								<s:iterator value="arrayListFilm" status="film">
									<tr class="success">
										<td><s:property value="film_id" /></td>
										<td><s:property value="film_name" /></td>
										<td><s:property value="film_diretor" /></td>
										<td><s:property value="film_actor" /></td>
										<td><s:iterator value="mapFilmType[film_id]" status="st">
											<s:if test="#st.last"><s:property value="type_name"/></s:if>
											<s:else><s:property value="type_name"/>、</s:else>
										</s:iterator></td>
										<td><s:property value="film_time" /></td>
										<td><a
											href="getFilm.action?filmBean.film_id=<s:property value="film_id"/>">编辑信息</a>
											<a
											href="deleteFilm.action?filmBean.film_id=<s:property value="film_id"/>">删除</a>
										</td>
									</tr>
								</s:iterator>
						</s:if>
						<s:else>
							<s:if test="filmBean!=null">
								<thead>
									<tr>
										<th>序号</th>
										<th>电影名</th>
								...
								<tbody>
									<tr class="success">
										<td><s:property value="filmBean.film_id" /></td>
										<td><s:property value="filmBean.film_name" /></td>
										<td><s:property value="filmBean.film_diretor" /></td>
										<td><s:property value="filmBean.film_actor" /></td>
										<td><s:iterator value="mapFilmType[filmBean.film_id]" status="st">
											<s:if test="#st.last"><s:property value="type_name"/></s:if>
											<s:else><s:property value="type_name"/>、</s:else>
										</s:iterator></td>
										<td><s:property value="filmBean.film_time" /></td>
										<td><a
											href="getFilm.action?filmBean.film_id=<s:property value="filmBean.film_id"/>">编辑信息</a>
											<a
											href="deleteFilm.action?filmBean.film_id=<s:property value="filmBean.film_id"/>">删除</a>
										</td>
									</tr>
							</s:if>
							</tbody>
