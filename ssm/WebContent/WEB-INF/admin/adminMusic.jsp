	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				...
				<li class="active"><a href="getAllUser.action">主页 <span
						...
						<s:if test="arrayListMusic!=null">
							...
							<tbody>
								...
								<s:iterator value="arrayListMusic" status="music">
									<tr class="success">
										<td><s:property value="music_id" /></td>
										<td><s:property value="music_name" /></td>
										<td><s:property value="music_time" /></td>
										<td><s:property value="music_singer" /></td>
										<td><s:property value="music_type" /></td>
										<td><a
											href="getMusic.action?musicBean.music_id=<s:property value="music_id"/>">编辑信息</a>
											<a
											href="deleteMusic.action?musicBean.music_id=<s:property value="music_id"/>">删除</a>
										</td>
									</tr>
								</s:iterator>
						</s:if>
						<s:else>
							<s:if test="musicBean!=null">
								<thead>
									<tr>
										<th>序号</th>
										<th>音乐名</th>
								...
								<tbody>
									<tr class="success">
										<td><s:property value="musicBean.music_id" /></td>
										<td><s:property value="musicBean.music_name" /></td>
										<td><s:property value="musicBean.music_time" /></td>
										<td><s:property value="musicBean.music_singer" /></td>
										<td><s:property value="musicBean.music_type" /></td>
										<td><a
											href="getMusic.action?musicBean.music_id=<s:property value="musicBean.music_id"/>">编辑信息</a>
											<a
											href="deleteMusic.action?musicBean.music_id=<s:property value="musicBean.music_id"/>">删除</a>
										</td>
									</tr>
							</s:if>
							</tbody>
