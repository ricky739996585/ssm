					...
					<div class="col-md-8 column">
						<form class="form-horizontal" role="form" method="post"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea rows="12" cols="18" class="form-control" name="bookBean.book_summary" placeholder="此处为图书简介"></textarea>
								</div>
							</div>
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">作者简介</label>
								<div class="col-sm-10">
									<textarea rows="12" cols="18" class="form-control" name="bookBean.author_summary" placeholder="此处为作者简介"></textarea>
								</div>
							</div>
							<div class="form-group">
