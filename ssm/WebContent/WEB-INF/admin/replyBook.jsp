			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="table-responsive" id="table">
					<table class="table">
						...
						<tbody>
							<s:iterator value="mapReplyBook" status="reply">
								<tr class="success">
									<td><s:property value="book_reply_id" /></td>
									<td><s:property value="user_name" /></td>
									<td><s:property value="book_name" /></td>
									<td><s:property value="book_reply_content" /></td>
									<td><s:property value="book_reply_score" /></td>
									<td><s:property value="book_reply_time" /></td>
								</tr>
							</s:iterator>
					</table>
				</div>
