				...
				<div class="table-responsive" id="table">
					<div class="col-md-8 column">
						<form class="form-horizontal" role="form" method="post"
							action="updateFilm.action" enctype="multipart/form-data">
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">电影海报</label>
								<div class="col-sm-10">
									<img src="${requestScope.filmImg }" width="200px"
										height="200px"><br />
									<br /> <input type="file" name="filmImg" value="选择图片" />
								</div>
							</div>
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">电影ID</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="filmBean.film_id"
										placeholder="请不要修改"
										value="<s:property value="filmBean.film_id"/>"
										readonly="readonly" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control"
										...
										value="<s:property value="filmBean.film_name"/>" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control"
										...
										value="<s:property value="filmBean.film_diretor"/>" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control"
										...
										value="<s:property value="filmBean.film_actor"/>" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control"
										...
										value="<s:property value="filmBean.film_url"/>" />
								</div>
							</div>
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">电影类型</label>
								<div class="col-sm-10">
									<s:iterator value="mapFilmType[filmBean.film_id]" status="st">
										<s:if test="#st.last">
											<s:property value="type_name" />
										</s:if>
										<s:else>
											<s:property value="type_name" />、</s:else>
									</s:iterator>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea rows="12" cols="18" class="form-control"
										name="filmBean.film_summary" placeholder="此处为简介" wrap="hard"><s:property
											value="filmBean.film_summary" /></textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea rows="12" cols="18" class="form-control"
										name="filmBean.film_detail" placeholder="此处为详细描述" wrap="hard"><s:property
											value="filmBean.film_detail" /></textarea>
								</div>
							</div>

							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									<button type="submit" class="btn btn-default">修改电影</button>
								</div>
							</div>
						</form>
					</div>
