		...
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="table-responsive" id="table">
					...
					<form class="form-horizontal" role="form" method="post" action="updateUser.action" enctype="multipart/form-data">
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">用户头像</label>
								<div class="col-sm-10">
									<img src="${requestScope.headImg }" width="200px" height="200px"><br/><br/>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="userBean.user_id" value="<s:property value="userBean.user_id"/>" placeholder="请不要修改" readonly="readonly"/>
								</div>
							</div>
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">用户姓名</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="userBean.user_name" placeholder="请输入姓名" value="<s:property value="userBean.user_name"/>"/>
								</div>
							</div>
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">用户密码</label>
								<div class="col-sm-10">
									<input type="password" class="form-control" name="userBean.user_psw" placeholder="请输入密码" value="<s:property value="userBean.user_psw"/>"/>
								</div>
							</div>
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">用户昵称</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="userBean.user_nick" placeholder="昵称：如小明.." value="<s:property value="userBean.user_nick"/>"/>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="userBean.user_status" placeholder="状态：活跃、禁用" value='<s:property value="userBean.user_status"/>'/>
								</div>
							</div>
