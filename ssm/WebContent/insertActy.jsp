					...
					<div class="col-md-8 column">
						<form class="form-horizontal" role="form" method="post"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="actyBean.user_id">
										<s:iterator value="arrayListUser" status="user">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="actyBean.acty_type">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea rows="12" cols="18" class="form-control"
										name="actyBean.acty_content" placeholder="此处为内容" wrap="hard"></textarea>
								</div>
							</div>
							<div class="form-group">
