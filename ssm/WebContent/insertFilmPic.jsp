				...
				<div class="table-responsive" id="table">
					<div class="col-md-8 column">
						<form class="form-horizontal" role="form" method="post"
							action="insertFilmPic.action" enctype="multipart/form-data">
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">电影海报</label>
								<div class="col-sm-10">
									<input type="file" name="filmPic" value="选择图片" />
									<br>
									<input type="file" name="filmPic" value="选择图片" />
									<br>
									<input type="file" name="filmPic" value="选择图片" />
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="filmPicBean.film_id">
										<s:iterator value="arrayListFilm" status="film">
											<option value='<s:property value="film_id"/>'><s:property value="film_name"/></option>
										</s:iterator>
									</select>
								</div>
							</div>
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									<button type="submit" class="btn btn-default">新增电影剧照</button>
								</div>
							</div>
						</form>
					</div>
