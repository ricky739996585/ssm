		...
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="table-responsive" id="table">
					...
					<form class="form-horizontal" role="form" method="post" action="insertMusic.action" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="musicBean.music_name" placeholder="请输入名字" />
								</div>
							</div>
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">演奏歌手</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="musicBean.music_singer" placeholder="请输入歌手" />
								</div>
							</div>
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">播放地址</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="musicBean.music_play" placeholder="请输入播放地址" />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea rows="12" cols="18" class="form-control" name="musicBean.music_lyric" placeholder="此处为歌词"></textarea>
								</div>
							</div>
